...
function NodeIcon({ n }) {
  ...
  if (n.id === 'outlook') return (
    <svg viewBox="0 0 24 24" fill="none" style={{ width: '100%', height: '100%' }}>
      <path d="M7.88 12.04q0 .45-.11.87-.1.41-.33.74-.22.32-.55.51-.34.18-.78.18t-.77-.18-.54-.51q-.23-.33-.33-.74-.1-.42-.1-.87t.1-.87q.1-.42.33-.74.22-.33.54-.51.33-.18.77-.18t.78.18q.33.18.55.51.23.32.33.74.11.42.11.87zM24 12v9.38q0 .46-.33.8-.33.32-.8.32H7.13q-.46 0-.8-.32-.32-.34-.32-.8V18H1q-.41 0-.7-.3-.3-.29-.3-.7V7q0-.41.3-.7Q.58 6 1 6h6.5V2.55q0-.44.3-.75.3-.3.75-.3h12.9q.44 0 .75.3.3.31.3.75V10.85l1.24.72h.01q.1.07.18.18.07.12.07.25zm-6-8.25v3h3zm-8 2.36v8.54l1-.59V7.13l-1 .98zM9.5 12.35q0-.66-.08-1.27-.07-.61-.27-1.12-.19-.5-.51-.85-.31-.34-.78-.47V6.5H2v9h6.86v-1.28q.44-.16.73-.48.3-.33.5-.82.2-.5.27-1.1.09-.6.09-1.27l-.05.8zm7.5 2.9l-4-2.37V9.17l4-2.32v8.4zM22 12.6l-1-.6v4.27L17 14v1.06l-3.5 2.04v.84q0 .06.03.12l3.5-2.04L22 18.2v-5.6z" fill="#0078D4"/>
    </svg>
  )

  if (n.id === 'outlook') return (
    <svg viewBox="0 0 24 24" fill="#0078D4" style={{ width: '100%', height: '100%' }}>
      <path d="M24 7.387v10.478L19.2 14.02l-5.4 3.64V7.387h.002zm-11.2 0v10.19l-5.352-3.544L2.4 17.402V7.387zm-1.332-1.174H13.6L7.2 10.95.8 6.213H1.2zm1.332 0h10.4l-5.2 3.533zM0 7.849v9.552l4.8-3.382zm24 0v9.552l-4.8-3.382z"/>
    </svg>
  )

  if (n.id === 'clay') return (
    <svg viewBox="0 0 100 100" style={{ width: '100%', height: '100%' }}>
      <rect width="100" height="100" rx="22" fill="#6B7EE0"/>
      <text x="50" y="68" textAnchor="middle" fill="white" fontSize="52" fontWeight="700" fontFamily="system-ui,sans-serif">C</text>
    </svg>
  )
