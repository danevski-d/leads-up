...
import { ArrowRight, Zap, Clock, Users, DollarSign, Calendar, TrendingUp } from 'lucide-react'
  ...
  return (
    <div style={{ ...cardStyle, padding: 18 }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
        {[
          { label: '🔥 Hot',    count: hot,  color: '#EF4444', bg: 'rgba(239,68,68,0.15)' },
          { label: '🟡 Warm',   count: warm, color: '#F59E0B', bg: 'rgba(245,158,11,0.15)' },
          { label: '🔵 Cold',   count: cold, color: '#60A5FA', bg: 'rgba(96,165,250,0.15)' },
              ...
              <div key={key} style={{ textAlign: 'center' }}>
                ...
                <div style={{ height: 3, borderRadius: 3, background: `${color}20` }}>
                  <div style={{
                    ...
                    width: `${leads.length ? Math.min((colLeads.length / leads.length) * 100, 100) : 0}%`,
...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    // Real-time — dashboard updates instantly when any lead changes
        ...
        <>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
            ...
            <MetricCard
              ...
              icon={Calendar}
              color="#34D399"
              sub={`${meetingLeads.length} scheduled`}
            />
            <MetricCard
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
            ...
            <div style={{ ...cardStyle, padding: 18 }}>
              ...
              <div style={{ fontSize: 32, fontWeight: 900, color: '#FBBF24', letterSpacing: '-1px', marginBottom: 4 }}>
                {wonLeads.length}
              </div>
            ...
            <div style={{ ...cardStyle, padding: 18 }}>
              ...
              <div style={{ height: 6, borderRadius: 6, background: '#1F2937' }}>
                <div style={{
                  height: '100%', borderRadius: 6, width: `${avgScore}%`,
