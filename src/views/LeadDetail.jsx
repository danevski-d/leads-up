...
export default function LeadDetail() {
  ...
  if (!lead) return (
    <div className="flex flex-col items-center justify-center h-64 gap-3 p-6">
      ...
      <button onClick={() => router.push('/app/leads')} className="text-sm" style={{ color: '#6366F1' }}>← Back to Pipeline</button>
    </div>
  )
  ...
  return (
    <div className="p-4 sm:p-5 md:p-6 max-w-4xl mx-auto">
      ...
      {/* Back button */}
      <button onClick={() => router.back()} className="flex items-center gap-2 text-sm mb-5 transition-colors" style={{ color: '#6B7280', minHeight: 44 }}
